...
describe("UAT FC REQ-6: /api/forms/contact accepts a valid POST", () => {
  ...
  it("returns 200 with success:true on a valid JSON submission", async () => {
    ...
    expect(json.dropped).toBe(false);
  });
});
